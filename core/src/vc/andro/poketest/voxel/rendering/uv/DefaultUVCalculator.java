...
public class DefaultUVCalculator implements UVCalculator {
    ...
    @NotNull
    private CubicGroup<TextureRegion> getTextureRegionsForVoxel(byte voxel) {
        CubicGroup<TextureRegion> textureRegions = VoxelSpecs.getSpecForVoxel(voxel).getTextureRegions();
